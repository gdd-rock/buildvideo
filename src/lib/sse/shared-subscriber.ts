...
type GlobalSharedSubscriber = typeof globalThis & {
  __buildvideoSharedSubscriber?: SharedSubscriber
}

const globalForSharedSubscriber = globalThis as GlobalSharedSubscriber

export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__buildvideoSharedSubscriber) {
    globalForSharedSubscriber.__buildvideoSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__buildvideoSharedSubscriber
}
