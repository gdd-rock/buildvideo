...
const IV_LENGTH = 16
const KEY_LENGTH = 32
// IMPORTANT: Do NOT change this salt value. It derives encryption keys for
// existing data. Changing it would make all previously encrypted API keys
// permanently undecryptable. The legacy name is intentionally preserved.
