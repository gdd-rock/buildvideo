...
export const QUEUE_NAME = {
  IMAGE: 'buildvideo-image',
  VIDEO: 'buildvideo-video',
  VOICE: 'buildvideo-voice',
  TEXT: 'buildvideo-text',
} as const
...
const IMAGE_TYPES = new Set<TaskType>([
  ...
  TASK_TYPE.ASSET_HUB_DIGITAL_HUMAN_GENERATE,
])

const VIDEO_TYPES = new Set<TaskType>([TASK_TYPE.VIDEO_PANEL, TASK_TYPE.LIP_SYNC, TASK_TYPE.VIDEO_MERGE])
