...
const globalForRedis = globalThis as typeof globalThis & {
  __buildvideoRedis?: RedisSingleton
}
...
const singleton = globalForRedis.__buildvideoRedis || {}
if (!globalForRedis.__buildvideoRedis) {
  globalForRedis.__buildvideoRedis = singleton
}
