...
export const POST = apiHandler(async (
  ...
  const { episodeId, transition, panelPreferences, subtitles, bgmUrl, bgmVolume, kenBurns, titleCards, introFade, outroFade, aiDirector } = body as {
    episodeId: string
