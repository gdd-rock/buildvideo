...
git rm --cached test_grsai_native.py -f 2>/dev/null || true  # 含 API key 的测试文件
git rm --cached test_grsai_models.py -f 2>/dev/null || true  # 含 API key 的测试文件
...
echo "=============================================="
echo "✅ 开源版本发布成功！"
echo "🔗 https://github.com/BuildVideoAI/buildvideo"
echo "=============================================="
echo ""
