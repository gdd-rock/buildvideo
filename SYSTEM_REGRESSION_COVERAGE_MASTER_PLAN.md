...
- [2026-02-25 10:00] 修改文件: ./tests/helpers/db-reset.ts, ./tests/helpers/request.ts, ./tests/helpers/auth.ts, ./tests/helpers/fixtures.ts
...
- [2026-02-25 10:05] 修改文件: ./tests/contracts/route-catalog.ts, ./tests/contracts/task-type-catalog.ts, ./tests/contracts/requirements-matrix.ts, ./scripts/guards/test-route-coverage-guard.mjs, ./scripts/guards/test-tasktype-coverage-guard.mjs, ./package.json
...
- [2026-02-25 10:10] 修改文件: ./src/lib/llm-observe/route-task.ts, ./src/lib/task/submitter.ts, ./src/lib/task/state-service.ts, ./tests/unit/helpers/*.test.ts
...
- [2026-02-25 10:15] 修改文件: ./tests/integration/api/helpers/call-route.ts, ./tests/integration/api/contract/*.test.ts, ./tests/integration/api/specific/*.test.ts
...
- [2026-02-25 10:20] 修改文件: ./tests/unit/worker/*.test.ts, ./tests/integration/chain/*.test.ts, ./tests/helpers/fakes/*.ts, ./tests/setup/env.ts, ./tests/unit/optimistic/task-target-state-map.test.ts, ./tests/unit/optimistic/sse-invalidation.test.ts
...
- [2026-02-25 10:25] 修改文件: ./tests/setup/global-setup.ts, ./tests/setup/global-teardown.ts, ./.github/workflows/test-regression-pr.yml
...
- [2026-02-25 10:30] 修改文件: ./scripts/test-regression-runner.sh, ./package.json
...
- [2026-02-25 10:40] 修改文件: ./SYSTEM_REGRESSION_COVERAGE_MASTER_PLAN.md
...
- [2026-02-25 22:00] 修改文件: ./src/lib/workers/handlers/reference-to-character.ts, ./tests/unit/worker/reference-to-character.test.ts, ./tests/contracts/requirements-matrix.ts, ./tests/contracts/requirements-matrix.test.ts, ./SYSTEM_REGRESSION_COVERAGE_MASTER_PLAN.md
