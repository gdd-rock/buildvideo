...
要改内容:
- 新增 `./tests/contracts/behavior-test-standard.md`
- 新增 `./scripts/guards/test-behavior-quality-guard.mjs`
硬性规则:
...
新增/扩展:
- `./tests/integration/api/specific/reference-to-character-api.test.ts`
- `./tests/integration/api/specific/characters-post-reference-forwarding.test.ts`（已完成，继续扩展）
...
- `./tests/unit/worker/voice-design.test.ts`
...
修改:
- `./.github/workflows/test-regression-pr.yml`
...
- [2026-02-25 21:59] 修改文件: ./tests/unit/worker/reference-to-character.test.ts, ./tests/unit/worker/asset-hub-image-suffix.test.ts, ./tests/unit/worker/modify-image-reference-description.test.ts, ./src/lib/workers/handlers/reference-to-character.ts
...
- [2026-02-25 22:00] 修改文件: ./tests/contracts/requirements-matrix.ts, ./tests/contracts/requirements-matrix.test.ts
...
- [2026-02-25 22:10] 修改文件: ./SYSTEM_BEHAVIOR_LEVEL_TEST_MASTER_PLAN.md
...
- [2026-02-25 22:20] 修改文件: ./SYSTEM_BEHAVIOR_LEVEL_TEST_MASTER_PLAN.md
...
- [2026-02-25 23:05] 修改文件: ./tests/integration/api/contract/direct-submit-routes.test.ts, ./tests/integration/api/contract/llm-observe-routes.test.ts
...
- [2026-02-25 23:06] 修改文件: ./tests/integration/api/contract/crud-routes.test.ts, ./tests/integration/api/contract/task-infra-routes.test.ts
...
- [2026-02-25 23:06] 修改文件: ./tests/unit/worker/image-task-handlers-core.test.ts, ./tests/unit/worker/episode-split.test.ts, ./tests/unit/worker/script-to-storyboard.test.ts, ./tests/unit/worker/video-worker.test.ts, ./tests/unit/worker/voice-worker.test.ts
...
- [2026-02-25 23:07] 修改文件: ./tests/integration/chain/image.chain.test.ts, ./tests/integration/chain/text.chain.test.ts, ./tests/integration/chain/video.chain.test.ts, ./tests/integration/chain/voice.chain.test.ts
...
- [2026-02-25 23:09] 修改文件: ./tests/integration/api/contract/crud-routes.test.ts
...
- [2026-02-25 23:09] 修改文件: ./tests/integration/api/contract/task-infra-routes.test.ts
...
- [2026-02-25 23:11] 修改文件: ./tests/contracts/behavior-test-standard.md, ./scripts/guards/test-behavior-quality-guard.mjs, ./package.json
...
- [2026-02-25 23:12] 修改文件: ./tests/integration/api/contract/direct-submit-routes.test.ts, ./tests/integration/api/contract/llm-observe-routes.test.ts
...
- [2026-02-25 23:13] 修改文件: ./tests/unit/optimistic/sse-invalidation.test.ts, ./tests/unit/optimistic/task-target-state-map.test.ts
...
- [2026-02-25 23:25] 修改文件: ./tests/unit/worker/story-to-script.test.ts, ./tests/unit/worker/screenplay-convert.test.ts, ./tests/unit/worker/analyze-novel.test.ts, ./tests/unit/worker/analyze-global.test.ts, ./tests/unit/worker/voice-analyze.test.ts, ./tests/unit/worker/clips-build.test.ts, ./tests/unit/worker/character-profile.test.ts, ./tests/unit/worker/character-image-task-handler.test.ts, ./tests/unit/worker/location-image-task-handler.test.ts, ./tests/unit/worker/panel-image-task-handler.test.ts, ./tests/unit/worker/panel-variant-task-handler.test.ts
...
- [2026-02-25 23:46] 修改文件: ./tests/integration/api/contract/crud-routes.test.ts, ./tests/integration/api/contract/task-infra-routes.test.ts
...
- [2026-02-25 23:46] 修改文件: ./tests/integration/chain/image.chain.test.ts, ./tests/integration/chain/text.chain.test.ts, ./tests/integration/chain/video.chain.test.ts, ./tests/integration/chain/voice.chain.test.ts
...
- [2026-02-25 23:47] 修改文件: ./tests/contracts/route-behavior-matrix.ts, ./tests/contracts/tasktype-behavior-matrix.ts, ./scripts/guards/test-behavior-route-coverage-guard.mjs, ./scripts/guards/test-behavior-tasktype-coverage-guard.mjs, ./package.json, ./tests/contracts/task-type-catalog.ts, ./docs/testing/behavior-test-guideline.md
